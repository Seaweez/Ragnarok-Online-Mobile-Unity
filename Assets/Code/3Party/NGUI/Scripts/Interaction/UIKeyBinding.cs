...
public class UIKeyBinding : MonoBehaviour
{
	...
	protected void UpdateTmpKey()
	{
		tmpKey = (KeyCode)PlayerPrefs.GetInt(keyAction.ToString());
		keyCode = tmpKey; //update
		if (keyCode == KeyCode.None && keyAction == KeyAction.item1)
        {
			keyCode = KeyCode.Alpha1;
		}
		if (keyCode == KeyCode.None && keyAction == KeyAction.item2)
		{
			keyCode = KeyCode.Alpha2;
		}
		if (keyCode == KeyCode.None && keyAction == KeyAction.item3)
		{
			keyCode = KeyCode.Alpha3;
		}
		if (keyCode == KeyCode.None && keyAction == KeyAction.item4)
		{
			keyCode = KeyCode.Alpha4;
		}
		if (keyCode == KeyCode.None && keyAction == KeyAction.item5)
		{
			keyCode = KeyCode.Alpha5;
		}
		if (keyCode == KeyCode.None && keyAction == KeyAction.swicthskill)
		{
			keyCode = KeyCode.Tab;
		}
	}
