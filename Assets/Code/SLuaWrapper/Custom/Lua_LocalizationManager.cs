...
public class Lua_LocalizationManager : LuaObject {
	...
	[UnityEngine.Scripting.Preserve]
	static public int Runscript(IntPtr l) {
		try {
			#if DEBUG
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int GetLocalizedText(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			System.String a1;
			checkType(l, 2, out a1);
			var ret=self.GetLocalizedText(a1);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_currentLanguage(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			LocalizationManager self=(LocalizationManager)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.currentLanguage);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_currentLanguage(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,Runscript);
		addMember(l,LoadLocalizedText);
		addMember(l,GetLocalizedText);
		addMember(l,"currentLanguage",get_currentLanguage,set_currentLanguage,true);
