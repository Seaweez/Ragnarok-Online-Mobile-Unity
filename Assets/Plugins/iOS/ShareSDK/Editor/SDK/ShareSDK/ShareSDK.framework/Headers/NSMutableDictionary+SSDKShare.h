...
/**
 ...
 视频的规格要求
 http://dev.twitter.com/rest/media/uploading-media.html Video specifications and recommendations
 */
- (void)SSDKSetupTwitterParamsByText:(NSString *)text
                               video:(NSURL*)video
                            latitude:(double)latitude
...
/**
 ...
 @param parts 多个使用逗号隔开 例如 snippet,status  参考 http://developers.google.com/youtube/v3/docs/videos/insert#part
 @param jsonString Video resource 的 json数据  参考 http://developers.google.com/youtube/v3/docs/videos
 */
- (void)SSDKSetupYouTubeParamsByVideo:(id)video
